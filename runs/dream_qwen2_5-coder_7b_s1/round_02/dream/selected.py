"""Dynamic batch selection policy that balances exploitation, exploration, and recovery. Prioritizes
high-potential branches, handles recoverable failures, and expands under-explored areas."""
...
class Policy:
    ...
    def select_batch(self, view: View) -> list[int]:
        ...
        # Prioritize branches by their best score and remaining depth
        prioritized_branches = sorted(branches.items(), key=lambda x: (-x[1][-1].score, x[1][-1].depth))
